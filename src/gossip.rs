...
impl Membership {
    pub fn new(this: Member, config: Config) -> Self {
        ...
        // keep updating the state in the background every session_timeout
        // so that we can remove dead nodes
        {
            ...
            tokio::spawn(async move {
                ...
                loop {
                    ...
                    Self::update_state(Utc::now(), state, vec![], vec![], &config);
                }
            });
        }
        Self {
